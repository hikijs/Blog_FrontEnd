...
import { useEffect, useRef, type ComponentPropsWithoutRef, forwardRef, createContext } from 'react'
...
export const EditorCommandOut = ({ query, range }: { query: string; range: Range }): JSX.Element => {
